...
class SrlProcessor(object):

    def __init__(self):
        self.START_MARKER = '<srl_start>'
        self.END_MARKER = '<srl_end>'
        self.label = ['B-ARG0', 'B-ARG1', 'B-ARG2', 'B-ARG3', 'B-ARG4', 'B-ARG5', 'B-ARGA', 'B-ARGM-ADJ', 'B-ARGM-ADV',
                      'B-ARGM-CAU', 'B-ARGM-COM', 'B-ARGM-DIR', 'B-ARGM-DIS', 'B-ARGM-DSP', 'B-ARGM-EXT', 'B-ARGM-GOL',
                      'B-ARGM-LOC', 'B-ARGM-LVB', 'B-ARGM-MNR', 'B-ARGM-MOD', 'B-ARGM-NEG', 'B-ARGM-PNC', 'B-ARGM-PRD',
                      'B-ARGM-PRP', 'B-ARGM-PRR', 'B-ARGM-PRX', 'B-ARGM-REC', 'B-ARGM-TMP', 'B-C-ARG0', 'B-C-ARG1',
                      'B-C-ARG2',
                      'B-C-ARG3', 'B-C-ARG4', 'B-C-ARGM-ADJ', 'B-C-ARGM-ADV', 'B-C-ARGM-CAU', 'B-C-ARGM-COM',
                      'B-C-ARGM-DIR',
                      'B-C-ARGM-DIS', 'B-C-ARGM-DSP', 'B-C-ARGM-EXT', 'B-C-ARGM-LOC', 'B-C-ARGM-MNR', 'B-C-ARGM-MOD',
                      'B-C-ARGM-NEG',
                      'B-C-ARGM-PRP', 'B-C-ARGM-TMP', 'B-R-ARG0', 'B-R-ARG1', 'B-R-ARG2', 'B-R-ARG3', 'B-R-ARG4',
                      'B-R-ARG5',
                      'B-R-ARGM-ADV', 'B-R-ARGM-CAU', 'B-R-ARGM-COM', 'B-R-ARGM-DIR', 'B-R-ARGM-EXT', 'B-R-ARGM-GOL',
                      'B-R-ARGM-LOC',
                      'B-R-ARGM-MNR', 'B-R-ARGM-MOD', 'B-R-ARGM-PNC', 'B-R-ARGM-PRD', 'B-R-ARGM-PRP', 'B-R-ARGM-TMP',
                      'B-V',
                      'I-ARG0', 'I-ARG1', 'I-ARG2', 'I-ARG3', 'I-ARG4', 'I-ARG5', 'I-ARGA', 'I-ARGM-ADJ', 'I-ARGM-ADV',
                      'I-ARGM-CAU',
                      'I-ARGM-COM', 'I-ARGM-DIR', 'I-ARGM-DIS', 'I-ARGM-DSP', 'I-ARGM-EXT', 'I-ARGM-GOL', 'I-ARGM-LOC',
                      'I-ARGM-MNR',
                      'I-ARGM-MOD', 'I-ARGM-NEG', 'I-ARGM-PNC', 'I-ARGM-PRD', 'I-ARGM-PRP', 'I-ARGM-REC', 'I-ARGM-TMP',
                      'I-C-ARG0',
                      'I-C-ARG1', 'I-C-ARG2', 'I-C-ARG3', 'I-C-ARG4', 'I-C-ARGM-ADJ', 'I-C-ARGM-ADV', 'I-C-ARGM-CAU',
                      'I-C-ARGM-COM',
                      'I-C-ARGM-DIR', 'I-C-ARGM-DIS', 'I-C-ARGM-DSP', 'I-C-ARGM-EXT', 'I-C-ARGM-LOC', 'I-C-ARGM-MNR',
                      'I-C-ARGM-MOD',
                      'I-C-ARGM-NEG', 'I-C-ARGM-PRP', 'I-C-ARGM-TMP', 'I-R-ARG0', 'I-R-ARG1', 'I-R-ARG2', 'I-R-ARG3',
                      'I-R-ARG4',
                      'I-R-ARGM-ADV', 'I-R-ARGM-CAU', 'I-R-ARGM-COM', 'I-R-ARGM-DIR', 'I-R-ARGM-EXT', 'I-R-ARGM-GOL',
                      'I-R-ARGM-LOC',
                      'I-R-ARGM-MNR', 'I-R-ARGM-PNC', 'I-R-ARGM-PRD', 'I-R-ARGM-PRP', 'I-R-ARGM-TMP', 'O']
    def get_labels(self):
        return self.label
    ...
    def get_examples(self, file_path):
        onotonotes_reader = Ontonotes()
        examples = []
        for conll_file in onotonotes_reader.dataset_path_iterator(file_path):
            for sentence in onotonotes_reader.sentence_iterator(conll_file):
                tokens = [t for t in sentence.words]
                if not sentence.srl_frames:
                    # Sentence contains no predicates.
                    tags = [self.label_map["O"] for _ in tokens]
                    verb_label = [0 for _ in tokens]
                    examples.append(Example(token=tokens, label=tags))
                else:
                    for (_, tags) in sentence.srl_frames:
                        verb_indicator = [1 if label[-2:] == "-V" else 0 for label in tags]
                        tmp_tokens = copy.deepcopy(tokens)
                        # modify token, add markers
                        tmp_tpkens, tags = self.add_markers(tmp_tokens, tags, verb_indicator)
                        tags = [self.label_map[t] for t in tags]
                        examples.append(Example(token=tmp_tokens, label=tags))

        return examples

    def add_markers(self, tmp_tokens, tags, verb_indicator):
        start = verb_indicator.index(1)
        if start == len(verb_indicator) - 1:
            end = len(verb_indicator)
        else:
            end = verb_indicator.index(0, start)
        tmp_tokens.insert(end, self.END_MARKER)
        tmp_tokens.insert(start, self.START_MARKER)

        tags.insert(end, 'O')
        tags.insert(start, 'O')

        return tmp_tokens, tags

if __name__ == '__main__':
    proc = SrlProcessor()
    examples = proc.get_examples('/Users/edison/PycharmProjects/MyNLP/examples/ontonote5.0srl/conll-formatted-ontonotes-5.0/data/train/')
    tags = set()
    for i in examples:
        for t in i['label']:
            tags.add(t)
